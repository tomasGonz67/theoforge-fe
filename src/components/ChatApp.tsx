 ...
 const handleSubmit = async (e?: FormEvent) => {
  ...
  return (
    ...
    <div className="flex h-screen">
      ...
      {/* Sidebar with toggle */}
      <motion.aside
        className={`bg-teal-100/15 shadow-md rounded-xl p-4 flex flex-col ${isSidebarOpen ? 'w-1/5 min-w-[250px] max-w-[250px]' : 'w-16 items-center'}`} 
